                ...
                <form @submit="onSubmit" class="flex flex-column align-items-center gap-2">
                    <div class="grid p-fluid" style="margin: auto">
                        <span class="p-float-label">
                            <InputText type="text" id="addDescription" v-model="dataPostStatusServices.description" :class="{ 'p-invalid': descriptionError }" style="max-width: 100px" />
                            <label for="addDescription"><span style="color: red">*</span> Descrição </label>
                        </span>
                        <span class="p-float-label ml-2">
                            <InputNumber id="addCod" v-model="dataPostStatusServices.cod" :class="{ 'p-invalid': codError }" style="max-width: 75px" />
                            <label for="addCod"><span style="color: red">*</span> Código </label>
                        </span>
                        <span class="p-float-label ml-2">
                            <Dropdown id="addColor" :options="colorTypes" v-model="dataPostStatusServices.color" style="min-width: 80px" :class="{ 'p-invalid': colorError }">
